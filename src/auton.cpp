...
namespace auton {
    ...
    void autonTest() {
        ...
        // 3 BALLS
        chassis.moveToPoint(23.5, -23, 4000, {.maxSpeed = 80});
        ...
        // MATCHLOAD
        chassis.moveToPoint(47, -48, 4000, {.forwards = false, .maxSpeed = 80});
        // pros::lcd::print(3, "%i", localization::count);
        chassis.turnToHeading(180, 4000, {.maxSpeed = 80});
        // pros::lcd::print(4, "%i", localization::count);
        pros::delay(700);
        matchLoader.set_value(true);
        pros::delay(350);
        chassis.moveToPose(47, -63, 180, 1200, {.maxSpeed = 80});
        pros::delay(1200);

        // LONG GOAL
        chassis.moveToPoint(48, -48, 1000, {.forwards = false});
        pros::delay(1100);
        chassis.moveToPose(48, -31, 0, 3000);
        pros::delay(500);
    ...
    void autonSkills() {
        ...
        // FIRST LOADER
        chassis.moveToPoint(120, 22, 1500, {.maxSpeed = 80});
        pros::delay(1550);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, false));
        chassis.turnToHeading(180, 500, {.maxSpeed = 80});
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        matchLoader.set_value(true);
        pros::delay(550);
        ...
        // FIRST LONG GOAL
        chassis.moveToPoint(120, 18, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.turnToHeading(0, 500, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPose(119.5, 41.5, 0, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(300);
        intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(119.5, 43.5, 500, {.maxSpeed = 20});
        pros::delay(550);
        chassis.setPose(120, 39, chassis.getPose().theta);
        // chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        pros::delay(2000);
        ...
        // ALLEY
        chassis.moveToPoint(120, 20, 1000, {.forwards = false, .maxSpeed = 80});
        topAligner.set_value(false);
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        wing.set_value(true);
        chassis.moveToPose(132, 50, 0, 2000);
        pros::delay(2050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPoint(130, 108, 2000, {.maxSpeed = 80});
        pros::delay(2200);
        chassis.setPose(utilities::getPoseWithDistance(true, true, false, false));

        // SECOND LOADER
        chassis.moveToPoint(112, 120, 4000, {.maxSpeed = 80});
        chassis.turnToHeading(0, 500, {.maxSpeed = 80});
        matchLoader.set_value(true);
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPoint(112, 136, 2000, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.moveToPoint(112, 137, 500, {.maxSpeed = 20});
        pros::delay(500);
        chassis.moveToPoint(112, 137, 500, {.maxSpeed = 20});
        pros::delay(500);

        // SECOND GOAL
        chassis.moveToPoint(112, 128, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.turnToHeading(180, 500, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPose(122.5, 105, 180, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(500);
        intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(122.5, 104, 500, {.maxSpeed = 20});
        pros::delay(550);
        chassis.setPose(120, 105, chassis.getPose().theta);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        pros::delay(500);
        ...
        // THIRD LOADER
        chassis.moveToPoint(120, 112, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        topAligner.set_value(false);
        chassis.turnToHeading(-90, 500, {.maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, false, true, false));
        chassis.moveToPoint(21.5, 112, 3000, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.setPose(utilities::getPoseWithDistance(true, true, false, false));
        pros::delay(1550);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, false));
        ...
        // THIRD LONG GOAL
        chassis.moveToPoint(23.25, 120, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.turnToHeading(180, 500, {.maxSpeed = 80});
        pros::delay(550);
        ...
        intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(25, 97, 500, {.maxSpeed = 20});
        pros::delay(550);
        chassis.setPose(24, 105, chassis.getPose().theta);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        pros::delay(500);
        ...
        // ALLEY
        chassis.moveToPoint(24, 119, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        topAligner.set_value(false);
        chassis.moveToPose(11, 92, 180, 2000);
        pros::delay(2050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPoint(13, 39, 2000, {.maxSpeed = 80});
        pros::delay(2050);
        chassis.setPose(utilities::getPoseWithDistance(true, true, false, false));
        ...
        // FOURTH GOAL
        chassis.moveToPoint(24, 20, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.turnToHeading(-1, 500, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        ...
        // PARK
        chassis.moveToPose(36, 12, 0, 4000, {.forwards = false});
        chassis.moveToPose(72, 0, 90, 100000, {.minSpeed = 100});
        pros::delay(1500);
        matchLoader.set_value(true);
    ...
    void autonSkillsLeft() {
        ...
        // FIRST LOADER
        chassis.moveToPoint(25, 22, 1200, {.maxSpeed = 80});
        pros::delay(1250);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, false));
        chassis.turnToHeading(180, 1000, {.maxSpeed = 80});
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        ...
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPoint(25, 11, 1500, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.moveToPoint(25, 9, 500, {.maxSpeed = 20});
        pros::delay(500);
        chassis.moveToPoint(25, 9, 500, {.maxSpeed = 20});
        pros::delay(500);

        // FIRST LONG GOAL
        chassis.moveToPoint(25, 18, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.turnToHeading(0, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.moveToPose(23, 41.5, 0, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(500);
        intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(23, 43.5, 500, {.maxSpeed = 20});
        pros::delay(550);
        chassis.setPose(24, 39, chassis.getPose().theta);
        pros::delay(200);
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        ...
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        wing.set_value(true);
        chassis.moveToPose(9, 50, 0, 2000);
        pros::delay(2050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.moveToPoint(11, 108, 1700, {.maxSpeed = 80});
        pros::delay(1750);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, true));

        // SECOND LOADER
        chassis.moveToPoint(23, 120, 4000, {.maxSpeed = 80});
        chassis.turnToHeading(0, 1000, {.maxSpeed = 80});
        matchLoader.set_value(true);
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.moveToPoint(23, 135, 2000, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.moveToPoint(23, 137, 500, {.maxSpeed = 20});
        pros::delay(500);
        chassis.moveToPoint(23, 137, 500, {.maxSpeed = 20});
        pros::delay(500);

        // SECOND GOAL
        chassis.moveToPoint(24, 128, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.turnToHeading(180, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPose(24, 105, 180, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(500);
        intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(24, 103, 500, {.maxSpeed = 20});
        pros::delay(550);
        chassis.setPose(24, 105, chassis.getPose().theta);
        pros::delay(1500);
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        ...
        // THIRD LOADER
        chassis.moveToPoint(24, 112, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        topAligner.set_value(false);
        chassis.turnToHeading(90, 1000, {.maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, true, false));
        chassis.moveToPoint(119, 112, 2500, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, true));
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, false));
        ...
        // THIRD LONG GOAL
        chassis.moveToPoint(119, 120, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.turnToHeading(180, 1000, {.maxSpeed = 80});
        pros::delay(1050);
        ...
        // 2ND ALLEY
        chassis.moveToPoint(120, 119, 700, {.forwards = false, .maxSpeed = 80});
        pros::delay(750);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        topAligner.set_value(false);
        chassis.moveToPose(135, 92, -180, 2000);
        pros::delay(2050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.moveToPoint(134, 39, 1700, {.maxSpeed = 80});
        pros::delay(1750);
        chassis.setPose(utilities::getPoseWithDistance(true, false, false, true));

        // FOURTH LOADER
        chassis.moveToPoint(120, 24, 4000, {.maxSpeed = 80});
        chassis.turnToHeading(-180, 1000, {.maxSpeed = 80});
        matchLoader.set_value(true);
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.moveToPoint(120, 8, 2000, {.maxSpeed = 80});
        pros::delay(1500);
        ...
        // FOURTH GOAL
        chassis.moveToPoint(120, 20, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.setPose(utilities::getPoseWithDistance(false, false, false, true));
        chassis.turnToHeading(1, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(1050);
        chassis.setPose(utilities::getPoseWithDistance(false, true, false, false));
        chassis.moveToPose(120, 38, 0, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(500);
        intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(120, 40, 500, {.maxSpeed = 20});
        pros::delay(550);
        chassis.setPose(120, 39, chassis.getPose().theta);
        pros::delay(1500);
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        ...
        // PARK
        chassis.moveToPoint(120, 20, 4000, {.forwards = false});
        chassis.moveToPose(72, 4, -95, 100000, {.minSpeed = 100});
        pros::delay(1500);
        matchLoader.set_value(true);
    ...
    void autonSkillsMCL() {
        ...
        chassis.setPose(-15.75, -50, -90);
        localization::start(-15.75, -50, -90);

        // FIRST LOADER
        chassis.moveToPoint(-47, -50, 1200, {.maxSpeed = 80});
        pros::delay(1250);
        chassis.turnToHeading(180, 1000, {.maxSpeed = 80});
        // intakeController::setIntakeState(intakeController::intakeState::Intake);
        matchLoader.set_value(true);
        pros::delay(1050);
        chassis.moveToPoint(-47, -61, 1500, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.moveToPoint(-47, -63, 500, {.maxSpeed = 20});
        pros::delay(500);
        chassis.moveToPoint(-47, -63, 500, {.maxSpeed = 20});
        pros::delay(500);

        // FIRST LONG GOAL
        chassis.moveToPoint(-47, -54, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.turnToHeading(0, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(1050);
        chassis.moveToPose(-48, -30.5, 0, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(500);
        // intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(-48, -28.5, 500, {.maxSpeed = 20});
        pros::delay(550);
        pros::delay(200);
        // intakeController::setIntakeState(intakeController::intakeState::Intake);
        ...
        pros::delay(1050);
        wing.set_value(true);
        chassis.moveToPose(-61, -22, 0, 2000);
        pros::delay(2050);
        chassis.moveToPoint(-61, 36, 1700, {.maxSpeed = 80});
        // localization::isResampling = false;
        pros::delay(1000);
        // localization::isResampling = true;
        pros::delay(750);

        // SECOND LOADER
        chassis.moveToPoint(-47, 48, 4000, {.maxSpeed = 80});
        chassis.turnToHeading(0, 1000, {.maxSpeed = 80});
        matchLoader.set_value(true);
        pros::delay(1050);
        chassis.moveToPoint(-47, 63, 2000, {.maxSpeed = 80});
        pros::delay(1500);
        chassis.moveToPoint(-47, 65, 500, {.maxSpeed = 20});
        pros::delay(500);
        chassis.moveToPoint(-47, 65, 500, {.maxSpeed = 20});
        pros::delay(500);

        // SECOND GOAL
        chassis.moveToPoint(-48, 56, 500, {.forwards = false, .maxSpeed = 80});
        pros::delay(550);
        chassis.turnToHeading(180, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        pros::delay(1050);
        chassis.moveToPose(-48, 33, 180, 4000, {.maxSpeed = 80});
        topAligner.set_value(true);
        matchLoader.set_value(false);
        pros::delay(500);
        // intakeController::setIntakeState(intakeController::intakeState::TopScore);
        pros::delay(500);
        chassis.moveToPoint(-48, 31, 500, {.maxSpeed = 20});
        pros::delay(550);
        pros::delay(1500);
        // intakeController::setIntakeState(intakeController::intakeState::Intake);

        // THIRD LOADER
        chassis.moveToPoint(-48, 40, 1000, {.forwards = false, .maxSpeed = 80});
        pros::delay(1050);
        topAligner.set_value(false);
        chassis.turnToHeading(90, 1000, {.maxSpeed = 80});
        pros::delay(1050);
        chassis.moveToPoint(47, 40, 2500, {.maxSpeed = 80});
        // localization::isResampling = false;
        pros::delay(1500);
        // // localization::isResampling = true;
        // pros::delay(1050);
        ...
        // chassis.moveToPoint(47, 63, 2000, {.maxSpeed = 80});
        // pros::delay(2000);
        // chassis.moveToPoint(47, 66, 500, {.maxSpeed = 20});
        // pros::delay(500);
        // chassis.moveToPoint(47, 66, 500, {.maxSpeed = 20});
        // pros::delay(500);

        // // THIRD LONG GOAL
        // chassis.moveToPoint(47, 48, 500, {.forwards = false, .maxSpeed = 80});
        // pros::delay(550);
        // chassis.turnToHeading(180, 1000, {.maxSpeed = 80});
        // pros::delay(1050);
        // chassis.moveToPose(48, 32, 180, 4000, {.maxSpeed = 80});
        // topAligner.set_value(true);
        // matchLoader.set_value(false);
        // pros::delay(500);
        // intakeController::setIntakeState(intakeController::intakeState::TopScore);
        // pros::delay(500);
        // chassis.moveToPoint(48, 30, 500, {.maxSpeed = 20});
        // pros::delay(550);
        // pros::delay(1500);
        // intakeController::setIntakeState(intakeController::intakeState::Intake);

        // // 2ND ALLEY
        // chassis.moveToPoint(48, 47, 700, {.forwards = false, .maxSpeed = 80});
        // pros::delay(750);
        // topAligner.set_value(false);
        // chassis.moveToPose(61, 20, -180, 2000);
        // pros::delay(2050);
        // chassis.moveToPoint(61, -33, 1700, {.maxSpeed = 80});
        // // localization::isResampling = false;
        // pros::delay(1000);
        // // localization::isResampling = true;
        // pros::delay(750);
        ...
        // matchLoader.set_value(true);
        // pros::delay(1050);
        // chassis.moveToPoint(47, -64, 2000, {.maxSpeed = 80});
        // pros::delay(1500);
        // chassis.moveToPoint(47, -66, 500, {.maxSpeed = 20});
        // pros::delay(500);
        // chassis.moveToPoint(47, -66, 500, {.maxSpeed = 20});
        ...
        // // FOURTH GOAL
        // chassis.moveToPoint(48, -52, 500, {.forwards = false, .maxSpeed = 80});
        // pros::delay(550);
        // chassis.turnToHeading(1, 1000, {.direction = lemlib::AngularDirection::CW_CLOCKWISE, .maxSpeed = 80});
        // pros::delay(1050);
        // chassis.moveToPose(48, -34, 0, 4000, {.maxSpeed = 80});
        // topAligner.set_value(true);
        // matchLoader.set_value(false);
        // pros::delay(500);
        // intakeController::setIntakeState(intakeController::intakeState::TopScore);
        // pros::delay(500);
        // chassis.moveToPoint(48, -32, 500, {.maxSpeed = 20});
        // pros::delay(550);
        // pros::delay(1500);
        // intakeController::setIntakeState(intakeController::intakeState::Intake);

        // // PARK
        // chassis.moveToPoint(48, -52, 4000, {.forwards = false});
        // chassis.moveToPose(0, -68, -95, 100000, {.minSpeed = 100});
        // pros::delay(1500);
        // matchLoader.set_value(true);
    ...
    void autonSAWP(bool isRedAlliance) {
        ...
        // MATCHLOAD
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        chassis.moveToPoint(67, 24, 4000, {.minSpeed = 5, .earlyExitRange = 0.5});
        ...
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        topAligner.set_value(false);
        chassis.moveToPose(84.25, 60.75, -45, 4000);
        pros::delay(1000);
        intakeController::setIntakeState(intakeController::intakeState::BottomScore);
        pros::delay(1000);

        // BALLS
        chassis.moveToPoint(96, 48, 1000, {.forwards = false});
    ...
    void autonLeft7Long(bool isRedAlliance) {
        ...
        pros::delay(1100);
        chassis.setPose(utilities::getPoseWithDistance(true, true, false, false));
        chassis.moveToPose(22.5, 41.5, -1, 3000);
        pros::delay(500);
        topAligner.set_value(true);
        pros::delay(100);
        matchLoader.set_value(false);
        ...
        // WINGS
        chassis.moveToPoint(12, 32, 4000, {.forwards = false, .maxSpeed = 80});
        intakeController::setIntakeState(intakeController::intakeState::Intake);
        topAligner.set_value(false);
        chassis.turnToHeading(2, 500, {.maxSpeed = 80});
        wing.set_value(true);
        chassis.moveToPose(13, 61.5, 0, 10000, {.maxSpeed = 60});
        wing.set_value(false);
